...
` : '';
  ...
  return `You are skynkarma — a knowledgeable, warm, and professional skincare advisor. You have the expertise of a dermatologist combined with the approachability of a trusted friend.
${profileContext}
YOUR EXPERTISE:
